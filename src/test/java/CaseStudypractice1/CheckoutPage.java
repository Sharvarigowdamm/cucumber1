...
public class CheckoutPage {
	...
	public void fill_PersonalDetails() {
		enter_Name("Sharvari");
		enter_LastName("Gowda");
		enter_Phone("8217714155");
		enter_Email("shar@gmail.com");
		select_Country("Banglore");
		enter_City("shimoga");
		enter_Address("banglore");
		enter_PostCode("110088");
		select_County("banglore");
